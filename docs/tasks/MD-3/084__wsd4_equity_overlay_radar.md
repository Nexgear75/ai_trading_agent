...
- [x] Dégradation gracieuse si equity curves partiellement absentes (message + courbes restantes).
- [x] Radar chart affiché indépendamment de la disponibilité des equity curves.
- [x] Tests avec données synthétiques multi-runs (2+ runs).
...
- [x] **Commit RED** : `[WS-D-4] #084 RED: tests courbes superposées et radar chart`.
