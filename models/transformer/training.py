...
def train(
    ...
    print(f"  d_model/nhead/layers: {cnn_cfg['channels']}")
    print(f"  Dropout: encoder={cnn_cfg['dropout_conv']}  fc={cnn_cfg['dropout_fc']}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Entraînement Transformer")
